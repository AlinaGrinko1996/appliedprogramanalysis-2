package ua.nure.swirchkov.Task3.part3;
...
public class Part3 {
	...
	private static String[] getValuesForType(String type) throws IOException {
		...
		case "char":
			return getValuesByPattern(Pattern.compile("[a-zA-Zà-ÿÀ-ß]{1}"));
		...
		case "String":
			return getValuesByPattern(Pattern.compile("[a-zA-Zà-ÿÀ-ß]{2}[a-zA-Zà-ÿÀ-ß]*"));
		}
		return new String[0];
	}
