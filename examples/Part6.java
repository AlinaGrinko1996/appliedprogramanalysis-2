...
public class Part6 {
	...
	private static List<Info> parseMailFile(Reader mailsReader) throws IOException {
		...
		while (!(line = readLine(mailsReader)).equals("")) {
			Pattern pat = Pattern.compile("#*[a-zA-Z0-9�-��-�]+;[a-zA-Z0-9�-��-�]+@[a-zA-Z0-9]+\\.[a-zA-Z]+");
			Pattern loginPat = Pattern.compile("#*[a-zA-Z0-9�-��-�]+;");
			Pattern mailPattern = Pattern.compile("[a-zA-Z0-9�-��-�]+@[a-zA-Z0-9]+\\.[a-zA-Z]+");
	...
	private static List<Info> parseGroupFile(Reader groupsReader, List<Info> list) throws IOException {
		...
		while (!(line = readLine(groupsReader)).equals("")) {
			Pattern pat = Pattern.compile("#*[a-zA-Z0-9�-��-�]+;[a-zA-Z�-��-�]+[0-9]+");
			Pattern loginPat = Pattern.compile("#*[a-zA-Z0-9�-��-�]+");
			Pattern groupPattern = Pattern.compile("[a-zA-Z0-9�-��-�]+[0-9]+");
